...
### [01-beginner-github-actions.md](./01-beginner-github-actions.md)
*   **Target Audience**: Junior DevOps Engineer.
*   **Key Concepts**: Workflows, Jobs, Steps, Events, GitHub-Hosted Runners.
*   **Analogy**: "The Assembly Line" - running tasks automatically.

### [02-intermediate-github-actions.md](./02-intermediate-github-actions.md)
*   **Target Audience**: Senior DevOps Engineer.
*   **Key Concepts**: Matrix Builds, Caching Dependencies, Secrets, Artifacts, Reusable Workflows.
...
### [05-top-100-github-actions-questions.md](./05-top-100-github-actions-questions.md)
*   **Target Audience**: Everyone (Exam/Interview Prep).
*   **Key Concepts**: 100 questions covering all facets of actions.
...
- **Bash/Shell Scripting**: Writing run steps.
- **Docker**: For actions and runner environments.
